...
> Help me with your referral [Link](https://t.me/BlockBits_bot/BlockBitsApp?startapp=G9ngzgM9)
...
```json
{
  ...
  "isDoTasks": true,
  "referralCode": "G9ngzgM9" - Your referral code, dont change it if you want to help me ^^
}
```
